...
public class MyServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       ;
        ...
        //out.println(name);
           out.println("</html>");
           //out.println("<form action=hellofin method=POST>");
...
session.setAttribute("restime1","123123");
//out.println(request.getAttribute("restime1"));
...
//out.println(Float.valueOf(restime)/(float)100);

//request.getRequestDispatcher("hellofin").forward(request, response);
...
//w[9]=0.0;
//out.println("<a href=hellofin?&restime=urlencode("+restime+")&availability=urlencode("+availability+")&throughput=urlencode("+throughput+")&success=urlencode("+success+")&reliability=urlencode("+reliability+")&compliance=urlencode("+compliance+")&bestpractices=urlencode("+bestpractices+")&latency=urlencode("+latency+")>NEXT</a>");
...
//out.println("<input type='submit' data-inline='true' value='next'>");
//out.println("</form>");
